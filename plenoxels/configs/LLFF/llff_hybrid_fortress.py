...
config = {
    ...
    "expname": "fortress_hybrid/2stage_samedecoder_testing",
    ...
    # Data settings
    "data_downsample": 4,
    "data_dirs": ["/media/public/disk5/lu/data/nerf_llff_data/fortress"],
    ...
    "pose_warmup_steps": 500, 
    "optim_type": "adam",
    
    "switch2grids_step": 6001, #FIXME:
    # "field_lr": [1e-2, 5e-3, 1e-3, 5e-4],
    "field_lr": 1e-3,   # 2stage
    "lr": 5e-3,#3e-3,#1e-2,#2e-2,
