...
config = {
    ...
    # "expname": "room_hybrid/linear_tvloss_dlr3e-3_gute",
    # "expname": "room_hybrid/linear_evalexpd_tvloss/evalstep_1e-2_1k_guteloadmodel",
    # "expname": "room_hybrid/1debug_msgenerator",
    # "expname": "room_hybrid/1grad_gutecode3x_s2g2k_s2woocc_evalalign_mul_pl2e-2_lr2e-3_dl3e-3_flr2e-2_dsdetach",
    
    # "expname": "room_hybrid/1dinograd_new_s2g2k_ea2e-3_nolinear",
    "expname": "room_hybrid/1_div3_newpl2e-2_s2g2k",
    ...
    ## Data settings
    "data_downsample": 4,
    "data_dirs": ["/media/public/disk5/lu/data/nerf_llff_data/room"],
    ...
    "pose_warmup_steps": 512,   # 1024 nan 
    "optim_type": "adam",
    

    ## 2nd stage settings
    "switch2grids_step": 2001,#2001,#6001, #FIXME:
    ...
    'proposal_generator_args_list': [
        {'model_ch': 8, 'model_out_ch': 16, 'model_res': [32, 32, 32], 'up_block_num': 2, 'block_out_channels': (32,64)},
        {'model_ch': 8, 'model_out_ch': 16, 'model_res': [64, 64, 64], 'up_block_num': 2, 'block_out_channels': (32,64)}
    ],
