...
config = {
    ...
    # "expname": "fern_hybrid/2stage_samedecoder_init_2stage_correct_up_relunolast",
    # "expname": "fern_hybrid/2stage_samedecoder_init_2stage_correct_up_relunolast",
    "expname": "fern_hybrid/1debug_msgenerator",
    ...
    ## Data settings
    "data_downsample": 4,
    "data_dirs": ["/media/public/disk5/lu/data/nerf_llff_data/fern"],
    ...
    "eval_steps": 10_01,
    "num_steps": 70_001, #60_001,
    "batch_size": 8192, #4096,
    "eval_batch_size": 4096, #4096,
    "scheduler_type": "warmup_cosine",
    "warmup_step": 128,
    ## "scheduler_type": "step",
    'scheduler_type_pose': "expdecay",
    "eval_scheduler_type": "step",
    "pose_warmup_steps": 256,#500, 
    "optim_type": "adam",
    

    ## 2nd stage settings
    "switch2grids_step": 6001, #FIXME:
