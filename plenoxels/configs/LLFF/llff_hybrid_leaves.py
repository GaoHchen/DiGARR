...
config = {
    ...
    # "expname": "leaves_hybrid/2stage_samedecoder_testing_3",
    # "expname": "leaves_hybrid/1_msgenerator_s2g3k_msmul",
    # "expname": "leaves_hybrid/1grad_gutecode3x_s2g4k_s2woocc_mul_pl1e-2_lr2e-3_dl1e-2_flrall1e-2_dsdetach",
    # "expname": "leaves_hybrid/1_dino_alr5e-3_lr2e-3toall2e-2_s2g4k_newpl2e-2wu128to5e-4",
    # "expname": "leaves_hybrid/1_div3_pl5e-2_s2g2k",
    "expname":"leaves_hybrid/1_div3_dinos_debug",
    ...
    ## Data settings
    "data_downsample": 4,
    "data_dirs": ["/media/public/disk5/lu/data/nerf_llff_data/leaves"],
    ...
    "learn_R": True,
    "learn_t": True,
    "pose_lr": 5e-2,#2e-2, #5e-4,  #TODO: modify
    "2stage_poselr": 5e-4,
    "pose_lr_end": 1e-5,
    # "t_lr": 1e-2,
    # "porf_lr": 5e-3,
    ...
    "pose_warmup_steps": 128,#500, 
    "pose_warmup_steps_s2": 1024, 
    "optim_type": "adam",
    

    ## 2nd stage settings
    "switch2grids_step": 2001,#4001, #FIXME:
    # "f_step": 500, #FIXME:300, 
    # "field_lr": [1e-2, 5e-3, 1e-3, 5e-4],
    "field_lr": [2e-2, 2e-2, 2e-2, 2e-2],#[2e-2, 2e-2, 1e-2, 1e-2],#[1e-2, 5e-3, 1e-3, 5e-4],
    # "field_lr": 1e-2,
    "lr": 2e-3,#2e-3,     #3e-3,#1e-2,#2e-2,
    "attn_lr": 5e-3,
    "density_lr": 1e-2,     #5e-3,#1e-2,
