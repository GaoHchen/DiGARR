...
#  'expname': 'cutbeef_hybrid/video_1framete',
    ...
    'expname': 'coffee_martini_hybrid/porf_base9k_all1e-2_dsfdetach_griddetach_dnorm_smooth1e-3_vqrf',
    # 'expname': 'cutbeef_hybrid/evaltest/31.96_neighbor',
...
#  'record': ['models_all', 'models', 'datasets', 'runners'],  # file backup
 ...
 'data_downsample': 4,#2,
#  'data_dirs':['/media/public/disk4/gaohc/DyNeRF/dynamic_dataset/dynerf/coffee_martini'],
 'data_dirs': ['/media/public/disk5/nerf_series_datas/dynerf_data/coffee_martini'],  # goodist
 'contract': False,
 'ndc': True,
 'ndc_far': 2.6,
 'near_scaling': 0.95,
...
#  "field_lr": [1e-2, 5e-3, 1e-3, 5e-4],#[2e-2, 1e-2, 2e-3, 1e-3],#[1e-2, 5e-3, 1e-3, 5e-4],
 ...
 'time_smoothness_weight': 0.001,#0.0001,
