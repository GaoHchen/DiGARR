...
#  'expname': 'cutbeef_hybrid/video_1framete',
    ...
    'expname': 'sear_steak_hybrid/randperm_base9k_all1e-2_dsfdetach_griddetach_dnotnorm_smooth1e-4',
...
#  'data_dirs': ['/media/public/disk5/doublez/NeRF-Pose/DyNeRF/dynamic_dataset/dynerf/cook_spinach'],
 'data_dirs': ['/media/public/disk5/nerf_series_datas/dynerf_data/sear_steak'],
