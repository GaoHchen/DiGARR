config = {
 ...
 'data_downsample': 2.0,
 'data_dirs': ['/media/public/disk5/doublez/NeRF-Pose/DyNeRF/dynamic_dataset/DNeRF-data/lego'],
 'contract': False,
 'ndc': False,
 'isg': False,
 'isg_step': -1,
 ...
 'n_frame_per_cam': 1,  # TODO: 300 for full evaluation
 'n_imgs_eval_per_step':1,
 "learn_pose": True,
 "learn_R": True,
 "learn_t": True,
 "hold_every": 8,
