...
from diffusers.models.vae import Decoder, Encoder, MSDecoder
...
@MODULES.register_module()
class MSVAEDecoder(MSDecoder, ModelMixin):  #TODO:
    def __init__(
            self,
            in_channels=12,
            out_channels=24,
        ...
        norm_num_groups = min(norm_num_groups, block_out_channels[0])  #@remind 我加的
...
@MODULES.register_module()
class VAEEncoder(Encoder, ModelMixin):
    def __init__(
            self,
            in_channels=12,
            out_channels=24,
            down_block_types=('UpDecoderBlock2D',),
            block_out_channels=(64,),
            layers_per_block=2,
            norm_num_groups=32,
            act_fn='silu',
