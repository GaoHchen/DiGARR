...
class LLFFDataset(BaseDataset):
    def __init__(self,
        ...
        if split == 'render':
            ...
            image_paths, self.poses, near_fars, intrinsics, num_cams_train = load_llff_poses(
    ...
    def __getitem__(self, index):
        ...
        out["camera_dirs"] = camera_dirs#.clone()
        ...
        out["intrinsics"] = self.intrinsics.get_matrix()#.clone()
...
def load_llff_poses(datadir: str,
    ...
    return image_paths, poses, near_fars, intrinsics, num_cams_train
